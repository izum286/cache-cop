...
All prices and thresholds are reconciled against the providers' public pages as of May 20, 2026. If you're reading this later, double-check the numbers. The mechanics will still hold.
...
DeepSeek is interesting right now precisely as a counterexample. For `deepseek-v4-flash` on May 20, 2026, a cache hit costs `$0.0028/MTok`, a cache miss `$0.14/MTok`, output `$0.28/MTok`. That's not the usual 10× discount — it's 50×.
...
| DeepSeek V4 Flash | $0.14/M | $0.0028/M | $0.28/M | disk cache, automatic |
| DeepSeek V4 Pro | $0.435/M | $0.003625/M | $0.87/M | 75% promo until May 31, 2026 |
...
- DeepSeek's promo ends eleven days after this article's date;

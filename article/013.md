...
All prices and thresholds are reconciled against the providers' public pages as of March 2, 2026. If you're reading this later, double-check the numbers. The mechanics will still hold.
...
DeepSeek is interesting right now precisely as a counterexample. For `deepseek-v4-flash` as of early March 2026, a cache hit costs `$0.005/MTok`, a cache miss `$0.20/MTok`, output `$0.40/MTok`. That's not the usual 10× discount — closer to 40×.

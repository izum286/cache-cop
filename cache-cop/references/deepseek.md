# DeepSeek Prompt Cache Reference
...
- usage field names
- compatibility of self-hosted DeepSeek models with various inference engines
...
For managed DeepSeek API, use DeepSeek docs. For self-hosted DeepSeek-family models, consult the inference engine documentation.

### MLA and Engine Compatibility

DeepSeek-family MLA models can have engine-specific cache behavior. Check the exact inference engine version and model support notes before recommending prefix-cache features.

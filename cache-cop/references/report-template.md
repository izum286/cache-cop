...
For repeatable runs, use `scripts/render_report.py` to generate this Markdown shape and its JSON companion from normalized usage logs plus one-line findings.
